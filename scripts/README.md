...
|---|---|---|
| [setup_env.ps1](setup_env.ps1) | Windows | Create `.venv`, upgrade pip, install `requirements-dev.txt` |
...
Run scripts from the **repository root** so relative paths (`experiments/...`, `requirements-dev.txt`) resolve correctly.
